...
<script type="text/javascript" src="http://s-moodledev/lib/yui/animation/animation-min.js"></script>
<script type="text/javascript" src="http://s-moodledev/lib/yui/yahoo-dom-event/yahoo-dom-event.js"></script>
...
YAHOO.lutsr.accordion2 = {
	...
	init : function(animation,animationDuration,multipleOpen) {
		...
		var accordion2Objects = Dom.getElementsByClassName("accordion2");

		if(accordion2Objects.length > 0) {

			for(var i=0; i<accordion2Objects.length; i++) {
				if(accordion2Objects[i].nodeName == "DL") {
					var headers = accordion2Objects[i].getElementsByTagName("dt");
...
initPage = function() {
	YAHOO.lutsr.accordion2.init(true, 10, false);
}
